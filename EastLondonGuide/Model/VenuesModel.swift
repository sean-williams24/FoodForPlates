...
extension Venue {
    ...
    static func venueData() -> [[String : String]] {
        return [
            ...
            [Venue.NameKey : "El Ganso Cafe", Venue.AreaKey : Area.LondonFields.rawValue, Venue.CategoryKey : "Food", Venue.DescritptionKey : Description.ElGansoCafe.rawValue,Venue.AddressKey : Address.ElGansoCafe.rawValue, Venue.OpeningTimesKey : OpeningTimes.ElGansoCafe.rawValue, Venue.PhoneKey : Telephone.ElGansoCafe.rawValue],
            ...
            [Venue.NameKey : "Broadway Market", Venue.AreaKey : Area.LondonFields.rawValue, Venue.CategoryKey : "Markets", Venue.DescritptionKey : Description.BroadwayMarket.rawValue, Venue.AddressKey : Address.BroadwayMarket.rawValue, Venue.OpeningTimesKey : OpeningTimes.BroadwayMarket.rawValue, Venue.PhoneKey : Telephone.BroadwayMarket.rawValue],
            ...
            [Venue.NameKey : "Howling Hops Brewery & Tank Bar", Venue.AreaKey : Area.HackneyWick.rawValue, Venue.CategoryKey : "Drinks", Venue.DescritptionKey : Description.HowlingHops.rawValue, Venue.AddressKey : Address.HowlingHops.rawValue, Venue.OpeningTimesKey : OpeningTimes.HowlingHops.rawValue, Venue.PhoneKey : Telephone.HowlingHops.rawValue],
            [Venue.NameKey : "HWK Coffee & Bar", Venue.AreaKey : Area.HackneyWick.rawValue, Venue.CategoryKey : "Coffee", Venue.DescritptionKey : Description.HWK.rawValue,Venue.AddressKey : Address.HWK.rawValue, Venue.OpeningTimesKey : OpeningTimes.HWK.rawValue, Venue.PhoneKey : Telephone.HWK.rawValue],
